...
import { brandListApi, brandDeleteApi } from "../../../service/serviceApi";
...
export default function List() {
  ...
  const handleUpdate = (newBrandId = 0) => {
  ...
  return (
    <>
      <div>
        ...
        >
          <Box sx={style}>
            <Edit closeEvent={handleEditClose} brandId={brandId} />
          </Box>
        </Modal>
      </div>
      {isLoading && <Loader />}
        ...
        <Paper sx={{ width: "98%", overflow: "hidden", padding: "12px" }}>
          ...
          <Stack direction="row" spacing={2} className="my-2 mb-2">
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField {...params} label="Marka Filtrele" margin="dense" />
              )}
